...
import { Trophy, Star, Target, ArrowRight, Award, Gift, History } from "lucide-react";
    ...
    <div className="min-h-screen bg-colizeum-dark p-4 pt-24">
      <div className="container mx-auto max-w-6xl">
        ...
        <Tabs defaultValue="battle-passes" className="space-y-6">
          <TabsList className="bg-colizeum-gray">
            <TabsTrigger value="battle-passes" className="data-[state=active]:bg-colizeum-cyan">
              <Trophy className="w-4 h-4 mr-2" />
              Боевые пропуски
            </TabsTrigger>
            <TabsTrigger value="rewards" className="data-[state=active]:bg-colizeum-cyan">
            ...
            <ScrollArea className="h-[500px] rounded-md border border-colizeum-cyan/20 p-4">
              {userRewards?.length ? (
                userRewards.map((reward) => (
                  <Card key={reward.id} className="bg-colizeum-gray border-colizeum-cyan/20 mb-4">
                    <CardHeader>
                      <div className="flex items-center space-x-4">
                        <div className="p-2 bg-colizeum-dark rounded-lg">
                          <Award className="w-6 h-6 text-colizeum-cyan" />
                        </div>
                        <div>
                ...
                <div className="text-center py-8">
                  <History className="w-12 h-12 text-colizeum-cyan mx-auto mb-4" />
